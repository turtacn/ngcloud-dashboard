...
import { getNameFilter, getStatusFilter, getDescriptionFilter } from '@/utils/common/tableFilter'
...
export default {
      ...
      list: this.$list.createList(this, {
        ...
        filterOptions: {
          ...
          alert_state: getStatusFilter({
            field: 'alert_state',
            statusModule: 'loggingresources',
            title: this.$t('logging.loggingresources.alert_state'),
          }),
        },
      }),
      exportDataOptions: {
  ...
  methods: {
    ...
    handleOpenSidepage (row, tab) {
      ...
      this.sidePageTriggerHandle(this, 'LoggingResourceSidePage', {
        id: row.id,
        resource: 'loggingresources',
        getParams: this.getParam,
        apiVersion: 'v1',
