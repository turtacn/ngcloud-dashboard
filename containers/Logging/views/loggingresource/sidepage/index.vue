...
<script>
import CommonalertList from '@Logging/views/commonalert/components/List'
import SidePageMixin from '@/mixins/sidePage'
import WindowsMixin from '@/mixins/windows'
import Actions from '@/components/PageList/Actions'
import VmInstanceLoggingSidepage from './Logging'
import ColumnsMixin from '../mixins/columns'
import SingleActionsMixin from '../mixins/singleActions'

export default {
  name: 'LoggingResourceSidePage',
  components: {
    CommonalertList,
    VmInstanceLoggingSidepage,
    Actions,
  },
  ...
  computed: {
    listId () {
      switch (this.params.windowData.currentTab) {
        ...
        case 'vm-instance-logging-sidepage':
          return 'VmInstanceLoggingSidepage'
        default:
          return ''
      }
    },
    detailTabs () {
      const tabs = [
        { label: this.$t('logging.text_122'), key: 'vm-instance-logging-sidepage' },
