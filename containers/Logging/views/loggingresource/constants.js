...
const TEMPERATURE_CPU_INPUT = {
  name: 'temp_input',
  label: i18n.t('compute.logging.temperature.cpu'),
...
const TEMPERATURE_DISK_INPUT = {
  name: 'temp_c',
  label: i18n.t('compute.logging.temperature.disk'),
  seleteItem: 'temp_c',
...
const TEMPERATURE_PCI_INPUT = {
  name: 'temp_input',
  label: i18n.t('compute.logging.temperature.pci'),
  seleteItem: 'temp_input',
  fromItem: 'agent_sensors',
  // groupBy: ['chip', 'feature'],
  groupBy: ['chip'],
...
const TEMPERATURE_VIRTUAL_INPUT = {
  name: 'temp_input',
  label: i18n.t('compute.logging.temperature.other_device'),
  seleteItem: 'temp_input',
  fromItem: 'agent_sensors',
  // groupBy: ['chip', 'feature'],
  groupBy: ['chip'],
