<template>
  <base-dialog @cancel="cancelDialog">
    <div slot="header">{{$t('logging.dashboard.dialog.create')}}</div>
    <div slot="body">
...
import ScopeSelect from '@Logging/components/LoggingCard/sections/select/scope'

export default {
  name: 'CreateLoggingDashboard',
  components: {
    ScopeSelect,
  },
