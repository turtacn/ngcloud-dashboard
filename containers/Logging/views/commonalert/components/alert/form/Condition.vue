...
import { preiodMaps } from '@Logging/constants'
...
export default {
  ...
  data () {
    ...
    return {
      ...
      durationOpts: [
        { key: 1, label: this.$t('logging.duration.label', [1]) },
        { key: 2, label: this.$t('logging.duration.label', [2]) },
        { key: 3, label: this.$t('logging.duration.label', [3]) },
        { key: 6, label: this.$t('logging.duration.label', [6]) },
        { key: 12, label: this.$t('logging.duration.label', [12]) },
        { key: 24, label: this.$t('logging.duration.label', [24]) },
        { key: 48, label: this.$t('logging.duration.label', [48]) },
        { key: 96, label: this.$t('logging.duration.label', [96]) },
      ],
      reduceOpts: [
        { key: 'avg', label: this.$t('logging.avg') },
        { key: 'min', label: this.$t('logging.min') },
        { key: 'max', label: this.$t('logging.max') },
      ],
      comparatorOpts: [
        { key: '>=', label: '>=' },
        { key: '<=', label: '<=' },
