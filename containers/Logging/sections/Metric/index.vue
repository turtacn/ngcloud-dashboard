    ...
    <a-col :span="span" v-if="showResType">
      <a-form-item class="mr-1">
        <base-select
          ...
          filterable
          :disabled="disabled"
          :select-props="{ placeholder: $t('logging.text_111'), loading }"
    ...
    <a-col :span="span">
      <a-form-item class="mr-1">
        <base-select
          ...
          :select-props="{ placeholder: $t('logging.text_112'), loading }"
    ...
    <a-col :span="span">
      <a-form-item>
        <base-select
          ...
          :select-props="{ placeholder: $t('logging.text_113'), allowClear: true, loading }" />
      </a-form-item>
    </a-col>
  </a-row>
</template>
