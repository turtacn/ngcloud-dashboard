<template>
  <a-card :title="title" size="small" class="explorer-logging-line">
    <div slot="extra">
      <slot name="extra" />
    </div>
...
import { tableColumnMaps } from '@Logging/constants'
...
export default {
  ...
  computed: {
    ...
    total () {
      ...
      return this.$t('logging_metric_78', [total])
    },
    columns () {
      const columns = [
        {
